...
} from "file:///Users/alemarsico/Documents/summit-of-the-future/node_modules/h3/dist/index.mjs";
import {
	getRequestDependencies,
	getPreloadLinks,
	getPrefetchLinks,
	createRenderer,
} from "file:///Users/alemarsico/Documents/summit-of-the-future/node_modules/vue-bundle-renderer/dist/runtime.mjs";
import {
	stringify,
	uneval,
} from "file:///Users/alemarsico/Documents/summit-of-the-future/node_modules/devalue/index.js";
...
import {
	...
	withTrailingSlash,
	joinRelativeURL,
} from "file:///Users/alemarsico/Documents/summit-of-the-future/node_modules/ufo/dist/index.mjs";
import {
	propsToString,
	renderSSRHead,
} from "file:///Users/alemarsico/Documents/summit-of-the-future/node_modules/@unhead/ssr/dist/index.mjs";
import {
	createFetch as createFetch$1,
	Headers as Headers$1,
} from "file:///Users/alemarsico/Documents/summit-of-the-future/node_modules/ofetch/dist/node.mjs";
import {
	createCall,
	createFetch,
} from "file:///Users/alemarsico/Documents/summit-of-the-future/node_modules/unenv/runtime/fetch/index.mjs";
...
import defu, {
	defuFn,
} from "file:///Users/alemarsico/Documents/summit-of-the-future/node_modules/defu/dist/defu.mjs";
import { hash } from "file:///Users/alemarsico/Documents/summit-of-the-future/node_modules/ohash/dist/index.mjs";
import {
	createStorage,
	prefixStorage,
} from "file:///Users/alemarsico/Documents/summit-of-the-future/node_modules/unstorage/dist/index.mjs";
...
import {
	toRouteMatcher,
	createRouter,
} from "file:///Users/alemarsico/Documents/summit-of-the-future/node_modules/radix3/dist/index.mjs";
...
import {
	...
	parseRawStackTrace,
} from "file:///Users/alemarsico/Documents/summit-of-the-future/node_modules/errx/dist/index.js";
import {
	isVNode,
	version,
	unref,
} from "file:///Users/alemarsico/Documents/summit-of-the-future/node_modules/vue/index.mjs";
import {
	createServerHead as createServerHead$1,
	CapoPlugin,
} from "file:///Users/alemarsico/Documents/summit-of-the-future/node_modules/unhead/dist/index.mjs";
...
const serverAssets = [
	{
		baseName: "server",
		dir: "/Users/alemarsico/Documents/summit-of-the-future/server/assets",
	},
];
...
storage.mount(
	...
	unstorage_47drivers_47fs({
		driver: "fs",
		readOnly: true,
		base: "/Users/alemarsico/Documents/summit-of-the-future",
...
storage.mount(
	...
	unstorage_47drivers_47fs({
		driver: "fs",
		readOnly: true,
		base: "/Users/alemarsico/Documents/summit-of-the-future/server",
		ignore: ["**/node_modules/**", "**/.git/**"],
	})
);
storage.mount(
	...
	unstorage_47drivers_47fs({
		driver: "fs",
		readOnly: false,
		base: "/Users/alemarsico/Documents/summit-of-the-future/.nuxt",
		ignore: ["**/node_modules/**", "**/.git/**"],
	})
);
storage.mount(
	...
	unstorage_47drivers_47fs({
		driver: "fs",
		readOnly: false,
		base: "/Users/alemarsico/Documents/summit-of-the-future/.nuxt/cache",
		ignore: ["**/node_modules/**", "**/.git/**"],
	})
);
storage.mount(
	...
	unstorage_47drivers_47fs({
		driver: "fs",
		base: "/Users/alemarsico/Documents/summit-of-the-future/.data/kv",
		ignore: ["**/node_modules/**", "**/.git/**"],
	})
);
...
const getClientManifest = () =>
	import(
		"file:///Users/alemarsico/Documents/summit-of-the-future/.nuxt/dist/server/client.manifest.mjs"
	)
		.then((r) => r.default || r)
