  ...
  <div>
    <Html>
      ...
      <Head>
        ...
        <Meta property="og:description" :content="chapter?.data?.meta_description" />
        <Meta property="og:image" :content="`${chapter?.data?.meta_image.url}&w=1920`" />
        <Meta property="og:type" content="website" />
        <Meta property="twitter:card" content="summary_large_image" />
        <Meta property="twitter:title" :content="chapter?.data?.meta_title" />
        <Meta property="twitter:description" :content="chapter?.data?.meta_description" />
        <Meta property="twitter:image" :content="`${chapter?.data?.meta_image.url}&w=1920`" />
      </Head>
