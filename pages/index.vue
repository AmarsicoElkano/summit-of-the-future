  ...
  <div>
    <Html>
      ...
      <Head>
        ...
        <Meta property="og:description" :content="`${$prismic.asText(metadata?.data?.description)}`" />
        <Meta property="og:image" :content="`${metadata?.data?.image.url}&w=1920`" />
        <Meta property="og:type" content="website" />
        <Meta property="twitter:card" content="summary_large_image" />
        <Meta property="twitter:title" :content="metadata?.data?.title" />
        <Meta property="twitter:description" :content="`${$prismic.asText(metadata?.data?.description)}`" />
        <Meta property="twitter:image" :content="`${metadata?.data?.image.url}&w=1920`" />
    ...
    <article class="relative">
      <!-- hero -->
      <section :ref="setRef"
        class="relative pt-[100px] md:pt-[174px] pb-[60px] pl-[16px] md:pl-[60px] min-h-dvh bg-gradient-to-b from-[var(--secondary-color)] to-[var(--third-color)]">
        ...
        <figure ref="heroArrow" class="md:absolute top-1/2 right-0 md:transform md:-translate-y-1/2">
          <svg class="w-full h-[auto]" width="1067" height="800" viewBox="0 0 1067 800" fill="none"
            ...
            <path d="M989.311 500.278H699.485C520.907 500.278 376.098 645.169 376.098 824"
              stroke="url(#paint0_radial_755_81)" stroke-width="80" stroke-miterlimit="10" />
            <path d="M40 833C40 563.923 253.624 173 693.078 173C1132.53 173 850.142 173 969.5 173"
              stroke="url(#paint1_linear_755_81)" stroke-width="80" stroke-miterlimit="10" />
            <g filter="url(#filter0_d_755_81)">
              <path d="M206 -160C206 42.6231 366.642 337 697.104 337C1027.57 337 874.245 337 964 337"
                stroke="url(#paint2_radial_755_81)" stroke-width="80" stroke-miterlimit="10"
            ...
            <defs>
              <filter id="filter0_d_755_81" x="113" y="-200" width="886" height="625" filterUnits="userSpaceOnUse"
                ...
                <feColorMatrix type="matrix" values="0 0 0 0 0.25098 0 0 0 0 0.517647 0 0 0 0 0.745098 0 0 0 0.1 0" />
              ...
              <radialGradient id="paint0_radial_755_81" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse"
                ...
                <stop offset="0.963494" stop-color="#E6F3F8" stop-opacity="0.25" />
              </radialGradient>
              <linearGradient id="paint1_linear_755_81" x1="951.437" y1="864.682" x2="-12.7697" y2="540.009"
                gradientUnits="userSpaceOnUse">
                <stop offset="0.210928" stop-color="#0B9CD9" />
                <stop offset="0.592645" stop-color="#FBB04D" stop-opacity="0.54" />
                <stop offset="0.742245" stop-color="#E6F3F8" stop-opacity="0.25" />
              </linearGradient>
              <radialGradient id="paint2_radial_755_81" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse"
                gradientTransform="translate(964 350) rotate(-161.556) scale(825.277 1294.47)">
                <stop offset="0.25179" stop-color="#FBB04D" />
                <stop offset="0.471311" stop-color="#009EDB" stop-opacity="0.87" />
                <stop offset="0.779778" stop-color="#009EDB" stop-opacity="0.05" />
                <stop offset="0.916589" stop-color="#E6F3F8" stop-opacity="0" />
              </radialGradient>
              <linearGradient id="paint3_linear_755_81" x1="385" y1="123" x2="982" y2="140"
                gradientUnits="userSpaceOnUse">
                <stop stop-color="#009EDB" stop-opacity="0" />
                <stop offset="1" stop-color="#0094D7" />
              </linearGradient>
              <linearGradient id="paint4_linear_755_81" x1="995" y1="336.326" x2="270.674" y2="368.123"
                gradientUnits="userSpaceOnUse">
                <stop offset="0.0213742" stop-color="#FBB04D" />
                <stop offset="0.512169" stop-color="#0B9CD9" stop-opacity="0.59" />
                <stop offset="0.922169" stop-color="#0B9CD9" stop-opacity="0" />
              </linearGradient>
              <linearGradient id="paint5_linear_755_81" x1="385" y1="450" x2="982" y2="467"
                gradientUnits="userSpaceOnUse">
                <stop stop-color="#009EDB" stop-opacity="0" />
                <stop offset="1" stop-color="#0094D7" />
              </linearGradient>
        ...
        <div ref="explore" @click="scrollToSection" class="flex gap-[20px] font-bold cursor-pointer text-primary">
          ...
          <svg class="mt-[10px] w-[27px] h-[30px] md:w-[59px] md:h-[55px]" width="59" height="55" viewBox="0 0 59 55"
            fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M57.5 38.5732L43.2714 52.8018L29.0429 38.5732" stroke="#004987" stroke-width="2"
              stroke-miterlimit="13.33" stroke-linecap="square" />
            <path d="M43.2773 50.6647L43.2773 1.69531L1 1.69531" stroke="#004987" stroke-width="2"
      ...
      <section :ref="setRef" class="px-[16px] md:px-[60px] pt-[160px] pb-[67px] relative">
        ...
        <figure class="absolute w-fit h-fit z-0 right-0 top-0">
          <img src="/img/cross-arrows.svg" class="bgGraphic" />
        </figure>

        <figure class="mb-[60px] block md:hidden" data-img>
          <PrismicImage class="" :field="doc.data.section_one_image" />
        </figure>
        ...
        <div class="flex">
          <figure class="md:w-1/2 hidden md:block" data-img>
            <PrismicImage class="" :field="doc.data.section_one_image" />
          </figure>
          <div class="md:w-1/2">
            <PrismicRichText class="text-base text-primary" data-reveal :field="doc.data.section_one_text" />
          </div>
      ...
      <!-- section two -->
      <section :ref="setRef"
        class="min-h-screen pb-[67px] bg-gradient-to-b from-[var(--third-color)] to-[var(--secondary-color)]">
        <div class="flex items-center	flex-col md:flex-row">
          ...
          <div class="w-full md:w-1/2 text-primary pr-[16px] pl-[16px] md:pl-[0px] md:pr-[60px]  pt-[250px]">
            ...
            <PrismicRichText class="" data-reveal :field="doc.data.section_two_text" />
          </div>
        </div>
      ...
      <section class="w-full relative bg-[var(--secondary-color)] block md:hidden">
        <div class="py-100 px-[16px] text-primary">
          <div class="">
            <ul>
              <li class="w-ful flex items-center mb-[10px] md:mb-10" :class="{ 'bg-white': index != 0 }"
                v-for="(item, index) in doc.data.chapters" :key="index">
                <div v-if="index != 0">
                  <div class="min-h-fit p-[24px] md:p-30">
                    ...
                    <NuxtLink :to="'/chapter/' + item.link.uid" class="flex items-center" ref="navItems">
                      <div
                        ...
                        Explore
                        <img src="../public/img/explore-right.svg" class="ml-[19px] md:ml-20 w-[27px] md:w-50" alt="" />
                      </div>
                    </NuxtLink>
                  </div>
                </div>
      ...
      <section class="w-full h-screen relative bg-[var(--secondary-color)] hidden md:block" :ref="setRef">
        <div class="relative h-full w-full">
          ...
          <div v-for="(item, index) in doc.data.chapters" :key="index" class="z-0 w-full h-full absolute"
                ...
                <div v-if="index != 0" class="mt-[40px]">
                  <NuxtLink :to="'/chapter/' + item.link.uid" class="flex items-center" ref="navItems">
                    <div class="flex gap-20 uppercase font-bold">
                      Explore
                      <img src="../public/img/explore-right.svg" class="" alt="" />
                    </div>
                  </NuxtLink>
                </div>
              </div>
              <figure class="w-1/2 h-fit left-0 top-0 z-0" data-img>
                <PrismicImage class="" :field="item.symbol" />
              </figure>
            </div>
          </div>
        </div>
      ...
      <section :ref="setRef" class="bg-[var(--secondary-color)] text-primary py-[100px]">
        ...
        <div v-for="(item, index) in doc.data.statistics" :key="index" class="hidden md:flex items-center gap-[30px]"
          :class="`arrows-info-${index + 1}`"
          :style="{ marginTop: index === 1 ? '-100px' : index === 2 ? '-40px' : index === 3 ? '-120px' : '0' }">
          <figure class="hidden md:block">
            <img :src="`./img/stats-arrows-${index + 1}.svg`" class="" />
          </figure>
        ...
        <div v-for="(item, index) in doc.data.statistics" :key="index"
          class="flex md:hidden items-center gap-[30px] mb-[10px]">
          <figure>
