...
<template>
	<section :ref="setRef" class="bg-gradient-to-b from-[var(--secondary-color)] to-[rgba(18, 52, 86, 0.2)] mt-[0px] md:mt-[100px] px-[16px] md:px-[60px] pb-[50px] md:pb-[100px] text-primary">
		<PrismicImage
			class="heroGraphic absolute top-0 right-0 w-full h-[auto] sm:max-w-700 md:max-w-950 opacity-30 md:opacity-100"
		...
		<div class="relative z-10">
			<PrismicRichText
				class="md:w-1/2 ml-[90px] md:ml-[50%]"
